...
def scenario_catalog() -> list[Scenario]:
    ...
    cases = [
        ...
        Scenario(
            ...
            roster=roster_with_updates(
                roster,
                {
                    ...
                    "Felix Bautista": {"starting_status_reason": "inactive_status"},
                },
            ),
        ...
        Scenario(
            name="injured_bench_hitter_not_used",
            description="A hitter carrying Yahoo IL status should never be activated from the bench even if his Yahoo profile is strong.",
            roster=replace(
                roster,
                players=[
                    player("1", "Shea Langeliers", "C", ("C", "Util"), is_starting_today=None, starting_status_reason="lineup_pending", yahoo_percent_started=92, yahoo_average_pick=70.0, yahoo_actual_rank_last_week=10),
                    player("2", "Hunter Goodman", "Util", ("C", "Util"), is_starting_today=None, starting_status_reason="lineup_pending", yahoo_percent_started=88, yahoo_average_pick=82.0, yahoo_actual_rank_last_week=18),
                    player("3", "Juan Soto", "BN", ("OF", "Util"), is_starting_today=None, starting_status_reason="inactive_status", yahoo_percent_started=97, yahoo_average_pick=3.0, yahoo_actual_rank_last_week=1, status="IL10"),
                ],
                slot_limits={"C": 1, "Util": 1, "BN": 1},
            ),
            expected_moves=(),
            expected_warnings=(),
        ),
